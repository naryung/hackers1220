...
<?php
	...
	if($_SESSION['completeTmp']==null){
		//Header("Location:/member/index.php?mode=step_03");
		echo "<script>location.href='/member/index.php?mode=step_03';</script>";
		exit;
	}

	unset($_SESSION['completeTmp']);
	...
	<div id="content" class="content">
		<div class="inner">
			...
			<div class="box-btn mt30">
				<a href="../member/login.html" class="btn-l">로그인</a>
